...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-gray-900">Editar Boleto</h1>
</div>
    ...
    <form action="{{ route('boletos.update', $boleto->id) }}" method="POST">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="nome_pagador" id="nome_pagador"
                    value="{{ old('nome_pagador', $boleto->nome_pagador) }}" required
            ...
            <div>
                ...
                <input type="text" name="cpf_cnpj_pagador" id="cpf_cnpj_pagador"
                    value="{{ old('cpf_cnpj_pagador', $boleto->cpf_cnpj_pagador) }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input type="text" name="nome_beneficiario" id="nome_beneficiario"
                    value="{{ old('nome_beneficiario', $boleto->nome_beneficiario) }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input type="text" name="cpf_cnpj_beneficiario" id="cpf_cnpj_beneficiario"
                    value="{{ old('cpf_cnpj_beneficiario', $boleto->cpf_cnpj_beneficiario) }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input type="date" name="data_vencimento" id="data_vencimento"
                    value="{{ old('data_vencimento', $boleto->data_vencimento->format('Y-m-d')) }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <select name="banco_id" id="banco_id" required
                    ...
                    <option value="{{ $banco->id }}"
                        {{ old('banco_id', $boleto->banco_id) == $banco->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <select name="cliente_id" id="cliente_id" required
                    ...
                    <option value="{{ $cliente->id }}"
                        {{ old('cliente_id', $boleto->cliente_id) == $cliente->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <textarea name="observacao" id="observacao" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('observacao', $boleto->observacao) }}</textarea>
                @error('observacao')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
