...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-gray-900">Editar Banco</h1>
</div>
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="nome_banco" id="nome_banco"
                    value="{{ old('nome_banco', $banco->nome_banco) }}" required
            ...
            <div>
                ...
                <input type="text" name="codigo_banco" id="codigo_banco"
            ...
            <div>
                ...
                <input type="number" name="percentual_juros" id="percentual_juros" step="0.01" min="0" max="100"
                    value="{{ old('percentual_juros', $banco->percentual_juros) }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
